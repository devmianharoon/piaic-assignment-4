...
let numbersArray:number[]=[0,20,0,2,-3,-2,90,-48,9,4]
let resultArray:number[]=removeNeagativeNumber(numbersArray);
...
function convertToFahtrenheit(celsius: number): number {
    return (celsius * 9/5) + 32;
}

function convertTemperaturesToFahtrenheit(celsiusTemperatures: number[]): number[] {
...
let celsiusTemperatures: number[] = [25, 30, 15,1 ,43,242,12,7,10, 4,65,20]; 
